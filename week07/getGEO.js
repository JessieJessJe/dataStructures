...
function getGEO(info){
    ...
    const URL = 'https://geoservices.tamu.edu/Services/Geocode/WebService/GeocoderWebServiceHttpNonParsed_V04_01.aspx';
     ...
     request(apiRequest, function(err, resp, body) {
        ...
        info.location = tamuGeo.InputAddress.StreetAddress;
        info.lat = tamuGeo.OutputGeocodes[0].OutputGeocode.Latitude;
        info.lng = tamuGeo.OutputGeocodes[0].OutputGeocode.Longitude;
